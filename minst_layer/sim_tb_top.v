...
module sim_tb_top;
  ...
  // Set these to 4 or 8 to match the RSA array build under test.
  localparam integer MATRIX_MAX_M = 8;
  localparam integer MATRIX_MAX_K = 8;
  localparam integer MATRIX_MAX_N = 8;
  ...
  // CASE0: MNIST MLP w8 QAT raw JSON (same contract as the RSA layer case0 include).
  // OUT := raw int32 matmul (no bias, no scale); safe for CASE0_COMPARE_OUTPUT_JSON=1.
  ...
  // Case index summary:
  //   0: 16x16 x 16x10, MNIST MLP raw int32 golden
  ...
  `include "mnist_mlp_w8_qat_raw_json_data.vh"
  task get_case_dims;
...
// Controlling the bi-directional BUS
  ...
  //***************************************************************************
  localparam integer CASE_DONE_TIMEOUT_CYCLES = 80000000;
