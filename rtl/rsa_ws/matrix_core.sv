...
module matrix_core #(
    ...
    input  logic [$clog2(SRAM_W / DATA_W)-1:0] base_col_offset_A,

    input  logic [ADDR_WIDTH-1:0]       base_addr_B,
    input  logic [ADDR_WIDTH-1:0]       row_stride_B,
    input  logic [$clog2(SRAM_W / DATA_W)-1:0] base_col_offset_B,
    ...
    matrix_fetch #(
        ...
        .fetch_col_offset (base_col_offset_A),
        .rd_valid         (a_rd_valid),
        .rd_addr          (a_rd_addr),
        .rd_ready         (a_rd_ready),
        .rd_data          (a_rd_data),
    ...
    matrix_fetch #(
        ...
        .fetch_col_offset (base_col_offset_B),
        .rd_valid         (b_rd_valid),
        .rd_addr          (b_rd_addr),
        .rd_ready         (b_rd_ready),
        .rd_data          (b_rd_data),
    ...
    logic [$clog2(SRAM_W / DATA_W)-1:0] b_cached_col_offset;
    ...
    always_comb begin
        need_load_b = !allow_b_reuse
                   ...
                   || (b_cached_col_offset != base_col_offset_B)
    ...
    matrix_systolic_array #(
        ...
        .mat_k_num       (mat_k_num),
        .mat_n_num       (mat_n_num),
        .cfg_row_mask    (cfg_row_mask),
        .cfg_col_mask    (cfg_col_mask),
