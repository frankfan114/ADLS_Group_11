...
module sim_tb_top;
  ...
  //***************************************************************************//
  // WS example-top quick-edit section
  ...
  begin : Logging
     ...
     if (PRINT_BENCH_RESULT_CSV != 0) begin
       ...
       if (bench_csv_fd == 0) begin
         ...
         $display("Writing WS example-top benchmark rows to benchmark_results.csv");
         $fdisplay(bench_csv_fd,
     ...
     fork
        begin : run_matrix_multicase
           ...
           if (!axi_test_fail)
             $display("TEST PASSED: WEIGHT-STATIONARY EXAMPLE_TOP (%0d cases)", NUM_CASES);
           else
             $display("TEST FAILED: WEIGHT-STATIONARY EXAMPLE_TOP");
        ...
        begin : test_timeout
           ...
           if (!init_calib_complete)
             ...
             $display("TEST FAILED: WEIGHT-STATIONARY EXAMPLE_TOP TIMEOUT");
