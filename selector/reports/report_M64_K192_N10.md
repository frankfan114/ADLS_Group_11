...
**Scoring weights:**  Performance = 0.50  |  Resource = 0.50
...
### #2 — Reconfigurable WS (SARA)  [4×4 tiles]

| Metric | Value |

|--------|-------|

| **Overall Score (normalised)** | `0.9905` |

| Performance Score | `0.5068` |

| Resource Score    | `0.8608` |
...
| Latency | 425169 cycles |

| Throughput | 0.2890 MAC/cycle |

| Memory Stall Ratio | 68.6% |
...
| Active PEs | 16 (hardware area proxy) |

| Read Bytes | 42787 (off-chip bandwidth) |
...
| Latency (cycles) | 153414 | 425169 (+177.1%) ❌ |

| Throughput (MAC/c) | 0.8010 | 0.2890 (-63.9%) ❌ |

| Active PEs | 64 | 16 (-75.0%) ✅ |

| Read Bytes | 16016 | 42787 (+167.2%) ❌ |

| Stall Ratio | 0.7434 | 0.6865 (-7.7%) ✅ |

| PE Utilisation | 0.0046 | 0.0127 (+177.1%) ✅ |

| B-reloads | 105 | 105 (0.0%) ❌ |
...
| 2 ◄ | Reconfigurable WS (SARA) | 4×4 | 0.9905 | 0.507 | 0.861 | 425169 | 0.2890 | 16 | 42787 | 68.6% |

| 3 | Output Stationary | 16×16 | 0.9508 | 0.827 | 0.490 | 162929 | 0.7542 | 64 | 17113 | 74.2% |

| 4 | Reconfigurable WS (SARA) | 8×8 | 0.7397 | 0.602 | 0.448 | 275881 | 0.4454 | 64 | 29401 | 73.2% |

| 5 | Weight Stationary | 8×8 | 0.6855 | 0.554 | 0.427 | 298692 | 0.4114 | 64 | 32031 | 73.6% |

| 6 | Weight Stationary + Ping-Pong | 4×4 | 0.5782 | 0.473 | 0.372 | 430129 | 0.2857 | 64 | 42787 | 69.7% |

| 7 | Output Stationary | 8×8 | 0.5211 | 0.465 | 0.307 | 356865 | 0.3443 | 64 | 38617 | 73.8% |

| 8 | Weight Stationary | 4×4 | 0.4805 | 0.405 | 0.316 | 494791 | 0.2483 | 64 | 50677 | 69.4% |

| 9 | Output Stationary + Ping-Pong | 8×8 | 0.4798 | 0.412 | 0.308 | 345102 | 0.3561 | 64 | 38617 | 76.5% |

| 10 | Output Stationary | 4×4 | 0.0205 | 0.138 | 0.000 | 701704 | 0.1751 | 64 | 73728 | 71.1% |
...
**Confidence score: `0.5437` — MEDIUM ⚠**
...
| rank_stability | 0.5 + 0.5 × min(gap / 0.15, 1) | `0.6325` |

| **confidence** | 0.65 × pred_quality + 0.35 × rank_stability | **`0.5437`** |
...
> d_nearest = `0.746`  |  score_gap (normalised) = `0.040`
...
**Final score formula:**  `score = 0.50 × perf_score + 0.50 × resource_score`
